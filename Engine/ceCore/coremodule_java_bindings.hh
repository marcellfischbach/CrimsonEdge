...
JNIEXPORT jobject JNICALL  Java_org_crimsonedge_core_CoreObject_nNew(JNIEnv *, jclass, jstring);
...
JNIEXPORT jboolean  JNICALL Java_org_crimsonedge_core_entity_Entity_nAttachState(JNIEnv*, jclass, jlong, jlong);
JNIEXPORT jboolean  JNICALL Java_org_crimsonedge_core_entity_Entity_nDetachState(JNIEnv*, jclass, jlong, jlong);
JNIEXPORT void JNICALL Java_org_crimsonedge_core_entity_Entity_nSetRoot(JNIEnv*, jclass, jlong, jlong);
JNIEXPORT jobject JNICALL Java_org_crimsonedge_core_entity_Entity_nGetRoot(JNIEnv*, jclass, jlong);

JNIEXPORT jobject JNICALL  Java_org_crimsonedge_core_entity_EntityState_nGetRoot(JNIEnv*, jclass, jlong);

JNIEXPORT void JNICALL  Java_org_crimsonedge_core_entity_StaticMeshState_nSetMesh(JNIEnv*, jclass, jlong, jlong);
JNIEXPORT jobject JNICALL  Java_org_crimsonedge_core_entity_StaticMeshState_nGetMesh(JNIEnv*, jclass, jlong);
